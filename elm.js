...
Elm.Main.make = function (_elm) {
   ...
   var makeGoal = F4(function (obj,rgb,width,height) {
      return A2($Graphics$Collage.move,
      {ctor: "_Tuple2",_0: obj.x,_1: obj.y},
      $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,
                                      $Color.white,
                                      A2($Graphics$Collage.rect,width + 2,height + 2))
                                      ,A2($Graphics$Collage.traced,
                                      $Graphics$Collage.solid(rgb),
                                      $Graphics$Collage.path(_U.list([{ctor: "_Tuple2"
                                                                      ,_0: width / 2
                                                                      ,_1: height / -2}
                                                                     ,{ctor: "_Tuple2",_0: width / -2,_1: height / -2}
                                                                     ,{ctor: "_Tuple2",_0: width / -2,_1: height / 2}
                                                                     ,{ctor: "_Tuple2",_0: width / 2,_1: height / 2}
                                                                     ,{ctor: "_Tuple2",_0: width / 2,_1: height / -2}])))])));
   });
   var make = F3(function (obj,rgb,shape) {
      return A2($Graphics$Collage.move,
      {ctor: "_Tuple2",_0: obj.x,_1: obj.y},
      A2($Graphics$Collage.filled,rgb,shape));
   });
   var title = "MarketInvoice Foo.bool";
   var msg = "SPACE to start, WASD and &larr;&uarr;&darr;&rarr; to move";
   ...
   var makePlayer = F2(function (obj,rgb) {
      ...
      $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,
                                      rgb,
                                      A2($Graphics$Collage.rect,20,26))
                                      ,A2($Graphics$Collage.move,
                                      {ctor: "_Tuple2",_0: -12,_1: 8},
                                      A2($Graphics$Collage.filled,rgb,A2($Graphics$Collage.rect,8,8)))
                                      ,A2($Graphics$Collage.move,
                                      {ctor: "_Tuple2",_0: 12,_1: 8},
                                      A2($Graphics$Collage.filled,rgb,A2($Graphics$Collage.rect,8,8)))
                                      ,A2($Graphics$Collage.move,
                                      {ctor: "_Tuple2",_0: 0,_1: 4},
                                      $Graphics$Collage.toForm(A3(txt,
                                      $Basics.identity,
   ...
   var updatePosition = F2(function (dt,obj) {
   ...
   var playerImpetus = F2(function (player,ball) {
   ...
   var limitMaxVelocity = function (velocity) {
      ...
      maxVelocity) > 0 ? maxVelocity : velocity;
   };
   ...
   var defaultGame = {state: Pause
                     ...
                     ,deltaState: 0};
   var updateBall = F4(function (dt,ball,player1,player2) {
      var p2RushKeeper = _U.cmp(ball.x,halfWidth) > 0 || A4(within,
      player2,
      ball,
      40,
      40);
      var p1RushKeeper = _U.cmp(ball.x,
      0 - halfWidth) < 0 || A4(within,player1,ball,40,40);
      var p2i = A2(playerImpetus,player2,ball);
      var p1i = A2(playerImpetus,player1,ball);
      var wallCollide = _U.cmp(ball.x,
      0 - halfWidth) < 0 || (_U.cmp(ball.x,
      halfWidth) > 0 || (_U.cmp(ball.y,
      7 - halfHeight) < 0 || _U.cmp(ball.y,halfHeight) > 0));
      var wallVelocity = wallCollide ? 0.7 : 1;
      return A2(updatePosition,
      dt,
      _U.update(ball,
      {vx: limitMaxVelocity(A3(stepV,
      ball.vx,
      p1RushKeeper,
      p2RushKeeper) + p1i.vx + p2i.vx) * wallVelocity
      ,vy: limitMaxVelocity(A3(stepV,
      ball.vy,
      _U.cmp(ball.y,7 - halfHeight) < 0,
      _U.cmp(ball.y,
      halfHeight - 7) > 0) + p1i.vy + p2i.vy) * wallVelocity}));
   });
   var updatePlayer = F5(function (dt,dirv,dirh,points,player) {
      var movedPlayer = A2(updatePosition,
      dt,
      _U.update(player,
      {vy: $Basics.toFloat(dirv) * 200
      ,vx: $Basics.toFloat(dirh) * 200}));
      return _U.update(movedPlayer,
      {y: A3($Basics.clamp,
      12 - halfHeight,
      halfHeight - 12,
      movedPlayer.y)
   ...
   var update = F2(function (_p5,_p4) {
      ...
      var _p7 = _p4;
      var _p13 = _p7.state;
      var _p12 = _p7.player2;
      var _p11 = _p7.player1;
      var _p10 = _p7.goal2;
      var _p9 = _p7.goal1;
      var _p8 = _p7.ball;
   ...
   var _p18 = {ctor: "_Tuple2",_0: 800,_1: 400};
   var gameWidth = _p18._0;
   var gameHeight = _p18._1;
   var view = F2(function (_p19,game) {
      var _p20 = _p19;
      var scores = A3(txt,
      $Text.height(50),
      A2($Basics._op["++"],
      $Basics.toString(game.player1.score),
      A2($Basics._op["++"],
      "  ",
      $Basics.toString(game.player2.score))),
      $Color.white);
      ...
      _U.list([A2($Graphics$Collage.filled,
              ...
              $Graphics$Collage.path(_U.list([{ctor: "_Tuple2"
                                              ,_0: halfWidth
                                              ,_1: 0 - goalArea}
                                             ,{ctor: "_Tuple2",_0: halfWidth - goalArea,_1: 0 - goalArea}
                                             ,{ctor: "_Tuple2",_0: halfWidth - goalArea,_1: goalArea}
                                             ,{ctor: "_Tuple2",_0: halfWidth,_1: goalArea}])))
              ,A2($Graphics$Collage.traced,
              $Graphics$Collage.dashed($Color.white),
              $Graphics$Collage.path(_U.list([{ctor: "_Tuple2"
                                              ,_0: 0 - halfWidth
                                              ,_1: goalArea}
                                             ,{ctor: "_Tuple2",_0: 0 - halfWidth + goalArea,_1: goalArea}
                                             ,{ctor: "_Tuple2",_0: 0 - halfWidth + goalArea,_1: 0 - goalArea}
                                             ,{ctor: "_Tuple2",_0: 0 - halfWidth,_1: 0 - goalArea}])))
              ,A3(make,
              game.ball,
              $Color.white,
              A2($Graphics$Collage.oval,15,15))
              ,A2(makePlayer,game.player1,$Color.red)
              ,A2(makePlayer,game.player2,$Color.blue)
              ,A4(makeGoal,game.goal1,$Color.red,10,72)
              ,A4(makeGoal,game.goal2,$Color.blue,10,72)
              ,A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: 0,_1: halfHeight - 40},
              $Graphics$Collage.toForm(scores))
              ,_U.eq(game.state,
              Play) ? $Graphics$Collage.toForm(A2($Graphics$Element.spacer,
              1,
              1)) : A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: 0,_1: 40 - halfHeight},
              $Graphics$Collage.group(_U.list([A2($Graphics$Collage.filled,
                                              $Color.white,
                                              A2($Graphics$Collage.rect,1.7 * halfWidth,40))
                                              ,$Graphics$Collage.toForm(A3(txt,
                                              $Text.height(24),
                                              msg,
                                              $Color.black))
                                              ,A2($Graphics$Collage.move,
                                              {ctor: "_Tuple2",_0: -54,_1: halfHeight - 40},
                                              $Graphics$Collage.toForm(A3(txt,
                                              $Text.height(32),
                                              "Risk",
                                              $Color.red)))
                                              ,A2($Graphics$Collage.move,
                                              {ctor: "_Tuple2",_0: 64,_1: halfHeight - 40},
                                              $Graphics$Collage.toForm(A3(txt,
                                              $Text.height(32),
                                              "Sales",
                                              $Color.blue)))
                                              ...
                                              title,
                                              $Color.black)))])))
              ,_U.eq(game.state,RiskScored) ? A2($Graphics$Collage.rotate,
              ...
              $Text.height(140),
              "REJECTED!",
              generateColor(game.deltaState))))) : $Graphics$Collage.toForm(A2($Graphics$Element.spacer,
              1,
              1))
              ,_U.eq(game.state,SalesScored) ? A2($Graphics$Collage.rotate,
              $Basics.degrees(game.deltaState),
              A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: 0,_1: 10},
              $Graphics$Collage.toForm(A3(txtBold,
