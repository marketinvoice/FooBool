...
Elm.Main.make = function (_elm) {
   ...
   var goalBlueLine = A2($Graphics$Collage.traced,
   $Graphics$Collage.dashed($Color.white),
   $Graphics$Collage.path(_U.list([{ctor: "_Tuple2"
                                   ,_0: 0 - halfWidth
                                   ,_1: goalArea}
   ...
   var menuItems = A2($Graphics$Collage.move,
   ...
   var field = A2($Graphics$Collage.filled,
   pitchGreen,
   ...
   var view = F2(function (_p19,game) {
      ...
      _U.list([field
              ...
              1)) : menuItems
              ,_U.eq(game.state,
              RiskScored) ? rejected(game) : $Graphics$Collage.toForm(A2($Graphics$Element.spacer,
              1,
              1))
              ,_U.eq(game.state,
              SalesScored) ? launched(game) : $Graphics$Collage.toForm(A2($Graphics$Element.spacer,
              1,
              1))])));
   });
